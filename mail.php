				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
							...
							<a href="tel:02 403 5894"><img src="img/elements/phonecall.png"/>(02) 403-5894</a>
							<a href="Catalogue.pdf" download><img src="img/elements/catalogue.png"/>Catalogues</a>
						</div>
					</div>			  					
				</div>
			</div>
				...
				<div class="row align-items-center justify-content-between d-flex">
					...
					<ul class="nav-menu">
						...
						<ul>
							...
							<li><a href="2_products-scaffolding frames.html">Scaffolding Frames</a></li>
							<li><a href="3_products-phenolic board.html">Phenolic Board</a></li>
							<li><a href="4_products-scaffolding systems.html">Scaffolding Systems</a></li>
							...
							<li><a href="9_products-metal panel form.html">Metal Panel</a></li>
							<li><a href="10_products-phenolic panels.html">Phenolic Panel</a></li>
					...
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-4 col-md-12 home-about-right relative">
							<form class="form-wrap" action="mail.php">
								...
								<div class="form-select" name="service" id="service-select">
									<select>
                            ...
                            <h3><font color="#fff">Quotation sent! Kindly wait for our feedback...</font></h3><br>
                        </div>
					</div>
				</div>	
			</section>
						...
						<div class="row">
							<div class="col-lg-5 col-md-6 col-sm-6">
								<div class="single-footer-widget">
									...
									<p><a href=""><img src="img/CTA_partnership.png"></a></p>
